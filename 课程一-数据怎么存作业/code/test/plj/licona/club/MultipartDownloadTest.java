...
import plj.liocna.club.util.MultipartDownload;
...
public class MultipartDownloadTest {
    ...
    @Test
    public void multipartDownloadTest() {
        ...
        MultipartDownload.multipartDownload(s3,bucketName, filePath,"test-multipartupload", 20 << 20);
    }
}
